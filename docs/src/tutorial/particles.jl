...
# All of these are subtypes of [`AbstractParticleType`](@extref QEDbase.AbstractParticleType).
...
# [`ParticleStateful`](@ref) is the implementation of QEDbase's [`AbstractParticleStateful`](@extref QEDbase.AbstractParticleStateful) interface. It represents a particle with a [`direction`](@extref QEDbase.ParticleDirection) (as used in the context of scattering processes, [`Incoming`](@extref QEDbase.Incoming), [`Outgoing`](@extref QEDbase.Outgoing), or [`UnknownDirection`](@extref QEDbase.UnknownDirection)), a particle species ([`Electron`](@ref), [`Positron`](@ref), [`Photon`](@ref), ...), and a 4-momentum Vector.
...
# Some more overloads for the momentum function exist, for a complete list please refer to its documentation: [`momentum`](@extref QEDbase.momentum), [`momenta`](@extref QEDbase.momenta).
